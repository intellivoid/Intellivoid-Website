...
<nav class="navbar navbar-expand-lg fixed-top navbar-transparent" color-on-scroll="100">
    <div class="container">
        <div class="navbar-translate">
            <a class="navbar-brand" href="<?PHP DynamicalWeb::getRoute('index', array(), true); ?>" rel="tooltip" title="<?PHP HTML::print(TEXT_NAVBAR_BRAND_TOOLTIP); ?>" data-placement="bottom">
                <span>INTELLIVOID•</span> Technologies
            </a>
            <button class="navbar-toggler navbar-toggler" type="button" data-toggle="collapse" data-target="#navigation" aria-controls="navigation-index" aria-expanded="false" aria-label="<?PHP HTML::print(TEXT_NAVBAR_TOGGLE_LABEL); ?>">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navigation">
            <div class="navbar-collapse-header">
                <div class="row">
                    ...
                    <div class="col-6 collapse-close text-right">
                        <button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#navigation" aria-controls="navigation-index" aria-expanded="false" aria-label="<?PHP HTML::print(TEXT_NAVBAR_TOGGLE_LABEL); ?>">
            ...
            <ul class="navbar-nav">
                <li class="nav-item p-0">
                    <a class="nav-link" rel="tooltip" title="<?PHP HTML::print(TEXT_NAVBAR_SOCIAL_TWITTER_TOOLTIP); ?>" data-placement="bottom" href="https://twitter.com/Intellivoid" target="_blank">
                        <i class="fab fa-twitter"></i>
                        <p class="d-lg-none d-xl-none">Twitter</p>
                    </a>
                </li>
                <li class="nav-item p-0">
                    <a class="nav-link" rel="tooltip" title="<?PHP HTML::print(TEXT_NAVBAR_SOCIAL_TELEGRAM_TOOLTIP); ?>" data-placement="bottom" href="https://t.me/Intellivoid" target="_blank">
                        <i class="fab fa-telegram-plane"></i>
                        <p class="d-lg-none d-xl-none">Telegram</p>
                    </a>
                </li>
                <li class="nav-item p-0">
                    <a class="nav-link" rel="tooltip" title="<?PHP HTML::print(TEXT_NAVBAR_SOCIAL_INSTAGRAM_TOOLTIP); ?>" data-placement="bottom" href="https://instagram.com/Intellivoid" target="_blank">
                        <i class="fab fa-instagram"></i>
                        <p class="d-lg-none d-xl-none">Instagram</p>
                    </a>
                </li>
                <li class="nav-item p-0">
                    <a class="nav-link" rel="tooltip" title="<?PHP HTML::print(TEXT_NAVBAR_SOCIAL_GITHUB_TOOLTIP); ?>" data-placement="bottom" href="https://github.com/Intellivoid" target="_blank">
